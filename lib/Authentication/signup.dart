...
//           'POST', Uri.parse('https://deepakdas.pythonanywhere.com/send-otp/'));
...
//           Uri.parse('https://deepakdas.pythonanywhere.com/verify-otp/'));
...
class _SignupPageState extends State<SignupPage> {
  ...
  bool _passwordVisible = false;
  bool _confirmPasswordVisible = false;
  // bool _emailSent = false; // Commented out as email verification is removed
  ...
  Future<void> _signup() async {
    ...
    try {
      ...
      // await userCredential.user!.sendEmailVerification(); // Commented out
      ...
      await FirebaseFirestore.instance
        ...
        'subscriptionExpiry': null,
        'createdAt': FieldValue.serverTimestamp(),
        // 'emailVerified': false, // Commented out
        'profile_status': false, // Set to false as profile is not complete yet
        'deviceId': DeviceId,
      });

      // setState(() {
      //   _emailSent = true; // Commented out
      // });

      // // Periodically check if email is verified
      // await _checkEmailVerification(userCredential.user!); // Commented out
  ...
  //   }
  // } // Commented out entire email verification check function
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: <Widget>[
                          // if (_emailSent) // Commented out email verification message
                          //   FadeInUp(
                          //     duration: Duration(milliseconds: 1800),
                          //     child: Container(
                          //       padding: const EdgeInsets.all(12),
